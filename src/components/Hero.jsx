...
const Hero = () => {
  ...
  return (
    <section id="home" className="min-h-[90vh] grid grid-cols-1 xl:grid-cols-8 relative bg-cover bg-center" style={{ backgroundImage: `url('Mallsur1.jpg')` }}>
      ...
      <div className="md:col-span-5 flex items-center justify-center p-8 xl:p-16 relative z-10">
        <div className="flex flex-col gap-8">
          <h1 className="text-5xl xl:text-7xl font-sans xl:leading-[7.5rem]">
            Alivio y Bienestar{" "}
